...
{
    const char* pszTimestamp = "GRCoin is Online";
    const CScript genesisOutputScript = CScript() << ParseHex("04f6433cd4fb89963e8b051dcfa8d4087f628dca738226a56a4403895af8847919ac599e0d0e0286a2b282bccfcc0269719de8787736359e25c4aab515b476b427") << OP_CHECKSIG;
...
//        consensus.nSmartnodePaymentsIncreasePeriod = 576 * 30; // 17280 - actual historical value
        ...
        consensus.BIP66Enabled = true; // 00000000000b1fa2dfa312863570e13fae9ca7b59097cb27e55422620b469aefa
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // GRCoin: 1 day
        consensus.nPowTargetSpacing = 90;                                                                  // GRCoin: 90 seconds
        ...
        genesis = CreateGenesisBlock(1719605268, 9097, 0x20001fff, 4, 21 * COIN);
...
//        vSeeds.emplace_back("202.61.238.92");
        ...
        // GRCoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 16);
        // GRCoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 128);
        // GRCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // GRCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // GRCoin BIP44 coin type is '5'
...
//        consensus.nFounderPayment = FounderPayment(rewardStructures, 1);
        ...
        vSporkAddresses = {"GMipY3GGww5QKW4gb8HrhHq28qNEY98aiG"};
        nMinSporkKeys = 1;
...
//        consensus.nSmartnodePaymentsIncreasePeriod = 10;
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // GRCoin: 1 day
        consensus.nPowTargetSpacing = 60;                                                                  // GRCoin: 1 minutes
 ...
 //       vSeeds.emplace_back("mtn.grcoin.com");
        ...
        // Testnet GRCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Testnet GRCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet GRCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet GRCoin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        chainTxData = ChainTxData{
            1719605268, // * UNIX timestamp of last known number of transactions (Block 213054)
...
public:
    CDevNetParams()
    {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // GRCoin: 1 day
        consensus.nPowTargetSpacing = 30;                                                              // GRCoin: 30 second
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("grcoin.net",  "devnet-seed.grcoin.net"));

        // Testnet GRCoin addresses start with 'e'
...
public:
    CRegTestParams()
    {
        ...
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60;                                                       // GRCoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60;                                                              // GRCoin: 2 minutes
        ...
        genesis = CreateGenesisBlock(1614369600, 2, 0x207fffff, 4, 21 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        // Regtest GRCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 140);
        // Regtest GRCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);
        // Regtest GRCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest GRCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest GRCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
